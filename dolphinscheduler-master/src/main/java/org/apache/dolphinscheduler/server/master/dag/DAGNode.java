...
public class DAGNode<E> {
    ...
    public DAGNode(String nodeName, E nodeValue, List<DAGEdge> inDegrees, List<DAGEdge> outDegrees) {
        this(nodeName, nodeValue, false, inDegrees, outDegrees);
    }

    public DAGNode(String nodeName, E nodeValue, boolean skip, List<DAGEdge> inDegrees, List<DAGEdge> outDegrees) {
